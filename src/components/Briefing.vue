	...
	<Observer>
		<section class='min-h-screen'>
			<div v-if="briefingStore.briefing" class="flex flex-col w-9/12 mx-auto max-lg:w-11/12 bg-gray-900 my-16 border border-gray-600 rounded-lg">
				...
				<p v-if="briefingStore.briefing.desc" v-html="renderMarkdown()" class='flex flex-col m-5 text-lg max-lg:text-sm text-gray-200 text-justify whitespace-pre-line'></p>
