declare global {
  const BriefingSchema: typeof import('../../server/models/briefingModel.js')['BriefingSchema']
  const UserSchema: typeof import('../../server/models/userModel.js')['UserSchema']
  ...
  const database: typeof import('../../server/utils/database.js')['default']
...
export { BriefingSchema } from '../../server/models/briefingModel';
export { UserSchema } from '../../server/models/userModel';
export { default as database } from '../../server/utils/database';